...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas. Ivan Daniel", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Matriz de vista: centrado horizontalmente y con perspectiva suficiente
		glm::mat4 view = glm::mat4(1.0f);
		view = glm::translate(view, glm::vec3(0.0f, -0.5f, -34.0f));
		...
		// CUBO 2. El segundo hacia arriba
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-0.2f, -3.5f, 0.0f));
		...
		// CUBO 3. El tercero hacia arriba
		model = glm::mat4(1.0f);
